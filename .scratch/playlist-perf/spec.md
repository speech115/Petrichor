...
| `019fe2c2-23fb-7af3-a399-77d4ded072a2` — «Продолжи промпт с картинками» | Тикеты 11–13: cold playlist, ETTrace/массовые инвалидации строк, полный аудит анимаций и light-theme/drag/tap follow-up Now Playing. | `934a10d`, `0605fdf`, `8a53d44`, `907076d`, `1fca87e`, `bfdee2f` |

Все перечисленные коммиты находятся в `origin/ios-port`. Детали, измерения и границы
