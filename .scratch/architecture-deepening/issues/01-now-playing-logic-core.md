...
- [x] seek-математика — один модуль `SeekScrub`; макош `PlayerView.progressSlider` использует его (у iOS нет интерактивного прогресс-бара — только неинтерактивная линия)
