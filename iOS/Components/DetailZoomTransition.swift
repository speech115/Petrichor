...
extension View {
    ...
    /// text rows that have no cover. No default — every source states its radius.
    func detailZoomSource(_ id: DetailZoomID, in namespace: Namespace.ID, cornerRadius: CGFloat) -> some View {
